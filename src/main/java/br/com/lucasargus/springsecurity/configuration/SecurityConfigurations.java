...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST, "/login").permitAll() // esta linha indica quais requisições são permitida
		.anyRequest().authenticated()                       // esta linha indica quais requisições necessitam de autenticação
